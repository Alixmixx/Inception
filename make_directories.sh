...
echo "DOMAIN_NAME=amuller.42.fr" > project/srcs/.env
echo "CERT_=./requirements/tools/amuller.42.fr.crt" >> project/srcs/.env
echo "KEY_=./requirements/tools/amuller.42.fr.key" >> project/srcs/.env
